...
class VCPConverters(base_driver_models.PConverters):

    enc_algorithm = partialmethod(
        base_driver_models.PConverters.enum_converter,
...
class VCCConverters(base_driver_models.CConverters):
    bytes_to_password_text = partialmethod(
        base_driver_models.CConverters.bytestring_to_ubyte_array,
    ...
    field_list = [
        ...
        base_driver_models.Field(
            name='wszLabel', alias='label', field_type=(
                ctypes.c_wchar * win.constants.VOLUME_LABEL_SIZE
                * win.constants.MAX_VOLUMES),
            is_indexed=True,
        ...
        base_driver_models.Field(
            name='volumeID', alias='volume_id', field_type=(
                ctypes.c_wchar * win.constants.VOLUME_ID_SIZE
                * win.constants.MAX_VOLUMES),
            is_indexed=True,
        ...
        base_driver_models.Field(
            name='diskLength', alias='disk_length', field_type=(
                ctypes.c_uint64 * win.constants.MAX_VOLUMES),
            is_indexed=True),

        # encryption algorithm
        base_driver_models.Field(
            name='ea', alias='enc_algorithm', field_type=(
                ctypes.c_int * win.constants.MAX_VOLUMES),
            is_indexed=True,
        ...
        base_driver_models.Field(
            name='truecryptMode', alias='truecrypt_mode', field_type=(
                wintypes.BOOL * win.constants.MAX_VOLUMES),
            is_indexed=True,
            converter=VCPConverters.win_bool),
    ] + base_driver_models.BaseStruct.base_fields

    _fields_ = base_driver_models.Field.iterable_to_struct_fields(field_list)


# noinspection PyTypeChecker
class PasswordStruct(base_driver_models.BaseStruct):
    field_list = [
        base_driver_models.Field(
...
class MountStruct(base_driver_models.BaseStruct):
    ...
    field_list = [
        ...
        base_driver_models.Field(
            ...
            field_type=ctypes.c_wchar * win.constants.VOLUME_LABEL_SIZE),
